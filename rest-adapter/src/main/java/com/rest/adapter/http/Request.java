...
import com.rest.adapter.http.toolbox.HurlStack;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     *
     * @deprecated Use {@link #Request(Context, int, String)}.
     */
    @Deprecated
    public Request(Context context, String url) {
        this(context, Method.DEPRECATED_GET_OR_POST, url);
    }
     ...
     */
    public Request(Context context, int method, String url) {
        mContext = context;
        mMethod = method;
        mUrl = url;
     ...
     */
    abstract protected T parseNetworkResponse(NetworkResponse response);
    ...
    public T request() throws SaturnError {
        ...
        try {
            response = network.performRequest(this);
        } catch (TimeoutError timeoutError) {
            mRetryPolicy.retry(timeoutError);
            request();
        }
